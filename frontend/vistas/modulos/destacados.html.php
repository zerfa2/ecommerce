	...
	<div class="container">
		...
		<ul class="grid0" >
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/accesorios/accesorio03.jpg" class="img-responsive">
					</a>
				</figure>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/accesorios/accesorio01.jpg" class="img-responsive">
					</a>
				</figure>
		...
		<ul class="list0" style="display: none">
			...
			<li class="col-xs-12">
				...
				<div class="col-lg-10 col-md-7 col-sm-8 col-xs-12">
					...
					<p class="text-muted">Lorem ipsum dolor sit ament otdod mdoo Lorem ipsum dolor sit ament otdod mdoo Lorem ipsum dolor sit ament otdod mdoo Lorem ipsum dolor sit ament otdod mdooLorem ipsum dolor sit ament otdod mdoo Lorem ipsum dolor sit ament otdod mdoo</p>
					<h2><small>GRATIS</small></h2>
	...
	<div class="container">
		...
		<ul class="grid1" >
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/ropa/ropa04.jpg" class="img-responsive">
					</a>
				</figure>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/ropa/ropa02.jpg" class="img-responsive">
					</a>
				</figure>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/ropa/ropa06.jpg" class="img-responsive">
					</a>
				</figure>
...
<div class="container-fluid productos">
	<div class="container">
		<div class="row">
			...
			<div class="col-xs-12 tituloDestacado">
				<div class="col-sm-6 col-xs-12">
					<h1><small>LOS MAS VISTO</small></h1>
				</div>
				<div class="col-sm-6 col-xs-12">
					<a href="lo-mas-visto">
						<button class="btn btn-default backColor pull-right">
		...
		<ul class="grid2" >
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="<?php echo $servidor; ?>vistas/img/productos/cursos/curso05.jpg" titulo="Curso de Bootstrap" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/cursos/curso04.jpg" class="img-responsive">
					</a>
				</figure>
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="<?php echo $servidor; ?>vistas/img/productos/cursos/curso04.jpg" titulo="Curso de Canvas y Javascript" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						</button>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/cursos/curso02.jpg" class="img-responsive">
					</a>
				</figure>
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="<?php echo $servidor; ?>vistas/img/productos/cursos/curso02.jpg" titulo="Aprende Javascript desde cero" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						</button>
			...
			<li class="col-md-3 col-sm-6 col-xs-12">
				<figure>
					<a href="#" class="pixelProducto">
						<img src="<?php echo $servidor; ?>vistas/img/productos/cursos/curso03.jpg" class="img-responsive">
					</a>
				</figure>
				...
				<div class="col-xs-6 enlaces">
					<div class="btn-group pull-right">
						...
						<button type="button" class="btn btn-default btn-xs agregarCarrito" idProducto="404" imagen="<?php echo $servidor; ?>vistas/img/productos/cursos/curso03.jpg" titulo="Curso de jQuery" precio="10" tipo="virtual" peso="0" data-toggle="tooltip" title="Agregar al carrito de compras">
							<i class="fa fa-shopping-cart" aria-hidden="true"></i>
						</button>
