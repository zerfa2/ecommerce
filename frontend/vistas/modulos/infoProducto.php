...
<div class="container-fluid infoProducto ">
	<div class="container">
		...
		<?php 
			$item = "ruta";
			$valor = $rutas[0];
			$infoproducto = productosControlador::ctrMostrarInfoProducto($item,$valor);
			...
			echo '</figure>
				...
				<div class="flexslider carousel">
				  ...
				  for ($i=0; $i <count($multimedia); $i++) { 
				  	echo '<li>
					      <img value="'.($i+1).'" src="'.$servidor.$multimedia[$i]["foto"].'" alt="'.$infoproducto["titulo"].'">
					    </li>';
				  }
			...
			';
				...
				echo '<div class="col-sm-6 col-xs-12">
					<iframe class="videoPresentacion" src="https://www.youtube.com/embed/'.$infoproducto["multimedia"].'?rel=0&autoplay=0&output=embed" width="100%" frameborder="0" allowfullscreen></iframe>
						...
						if($infoproducto["entrega"] ==0){
							...
							if($infoproducto["precio"] ==0){
								echo '<h4 class="col-xs-12">
										...
										<span class="label label-default" style="font-weight:100">
											...
											visto por: <span class="vistas" precio="'.$infoproducto["precio"].'">'.$infoproducto["vistasGratis"].'</span> personas
										</span>
									</h4>';
							}else{
								echo '<h4 class="col-xs-12">
										...
										<span class="label label-default" style="font-weight:100">
											...
											<i class="fa fa-eye" style="margin:0px 5px;"></i> 
											visto por: <span class="vistas" precio="'.$infoproducto["precio"].'">'.$infoproducto["vistas"].'</span> personas
										</span>
									</h4>';
							}
						}else{
							...
							if($infoproducto["precio"] ==0){
								echo '<h4 class="col-xs-12">
										...
										<span class="label label-default" style="font-weight:100">
											<i class="fa fa-clock-o" style="margin-right:5px;"></i> 
											'.$infoproducto["entrega"].' dias hábiles de entrega	 | 
											<i class="fa fa-shopping-cart" style="margin: 0px 5px;"></i>
											'.$infoproducto["ventasGratis"].' solicitudes |
											<i class="fa fa-eye" style="margin:0px 5px;"></i> 
											visto por: <span class="vistas" precio="'.$infoproducto["precio"].'">'.$infoproducto["vistasGrat</span>is"].' personas
										</span>
									</h4>';	
							}else{
								...
								echo '<h4 class="col-md-12 col-sm-0 col-xs-0">
									...
									<h4 class="col-lg-0 col-md-0 col-xs-12">
										...
										<small style="font-weight:100">
											<i class="fa fa-clock-o" style="margin-right:5px;"></i> 
											'.$infoproducto["entrega"].' dias hábiles de entrega <br> 
											<i class="fa fa-shopping-cart" style="margin: 0px 5px;"></i>
			...
			<?php 
				if($infoproducto["precio"]==0){
					...
					if($infoproducto["tipo"]=="virtual"){
						echo '<div class="col-md-3 col-xs-12"></div><div class="col-md-6 col-xs-12">
								<button class="btn btn-default btn-block btn-lg backColor">ACCEDER AHORA</button>
							</div>'; 
					}else{
						echo '<div class="col-md-3 col-xs-12"></div><div class="col-md-6 col-xs-12">
					...
					if($infoproducto["tipo"]=="virtual"){
						...
						echo '<div class="row">
								<div class="col-md-6 col-xs-12">
									<button class="btn btn-default btn-block btn-lg backColor">ADICIONAR AL CARRITO
										<i class="fa fa-shopping-cart"></i>
									</button>
								</div>
							</div>';
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-xs-12 tituloDestacado">
					...
					$rutaArticulosRelacionados = productosControlador::ctrMostrarSubCategorias($item,$valor);
					// var_dump($rutaArticulosRelacionados[0]["ruta"]);
					 
					echo'<a href="'.$rutaArticulosRelacionados[0]["ruta"].'">
			...
			$relacionados =productosControlador::ctrMostrarProductos($ordenar,$item,$valor,$base,$tope,$modo);
